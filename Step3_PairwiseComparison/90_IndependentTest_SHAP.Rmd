...
plot_ATH_Rice = ggplot(df1, aes(x = factor(X1, levels = c("Atrichoblast2", "Atrichoblast1", "Trichoblast2",  "Trichoblast1",  "Cortex","Meristem_Endocortex", "Xylem", "Phloem",  "Stele2", "Stele1",  "Endodermis")), y = factor(X2, levels = c("Atrichoblast", "Trichoblast2",  "Trichoblast1",   "Meristem", "Cortex","Cortex_like", "Exodermis", "Xylem", "Phloem",  "Stele",  "Endodermis")), fill = value)) +
       geom_tile() + 
       geom_text(aes(label = value), color = "black") +
       scale_fill_gradient(low = "white", high = "tomato1") +
       geom_rect(data = subset(df1, test == "Reject"), 
            aes(xmin = as.numeric(factor(X1, levels = c("Atrichoblast2", "Atrichoblast1", "Trichoblast2",  "Trichoblast1",  "Cortex","Meristem_Endocortex", "Xylem", "Phloem",  "Stele2", "Stele1",  "Endodermis"))) - 0.5, xmax = as.numeric(factor(X1, levels = c("Atrichoblast2", "Atrichoblast1", "Trichoblast2",  "Trichoblast1",  "Cortex","Meristem_Endocortex", "Xylem", "Phloem",  "Stele2", "Stele1",  "Endodermis"))) + 0.5, 
                ymin = as.numeric(factor(X2, levels = c("Atrichoblast", "Trichoblast2",  "Trichoblast1",   "Meristem", "Cortex","Cortex_like", "Exodermis", "Xylem", "Phloem",  "Stele",  "Endodermis"))) - 0.5, ymax = as.numeric(factor(X2, levels = c("Atrichoblast", "Trichoblast2",  "Trichoblast1",   "Meristem", "Cortex","Cortex_like", "Exodermis", "Xylem", "Phloem",  "Stele",  "Endodermis"))) + 0.5), 
            fill = NA, color = "green4", size = 1) +
...
pdf("/Users/tranchau/Documents/SC_crossSpecies/092522_allSteps/Figure/Figure_independentTest/111222_Independent_SHAP/030823_ATH_Rice_count.pdf", width = 7, height = 5)
plot_ATH_Rice
dev.off()
```
...
# This heatmap counts the actual number of common MGs between two species
plot_Rice_Tom = ggplot(df1, aes(x = factor(X1, levels = c("Xylem", "Phloem", "Cortex", "Cortex_like", "Exodermis", "Endodermis", "Meristem", "Trichoblast1", "Trichoblast2", "Atrichoblast", "Stele")), y = factor(X2, levels = c("Xylem", "Phloem1", "Phloem2", "EXO_iCOR1", "EXO_iCOR2", "Exodermis1", "Exodermis2", "MZ", "Epidermis1", "Epidermis2", "Vascular1", "Vascular2")), fill = value)) +
       geom_tile() + 
       geom_text(aes(label = value), color = "black") +
       scale_fill_gradient(low = "white", high = "tomato1") +
       geom_rect(data = subset(df1, test == "Reject"), 
            aes(xmin = as.numeric(factor(X1, levels = c("Xylem", "Phloem", "Cortex", "Cortex_like", "Exodermis", "Endodermis", "Meristem", "Trichoblast1", "Trichoblast2", "Atrichoblast", "Stele"))) - 0.5, xmax = as.numeric(factor(X1, levels = c("Xylem", "Phloem", "Cortex", "Cortex_like", "Exodermis", "Endodermis", "Meristem", "Trichoblast1", "Trichoblast2", "Atrichoblast", "Stele"))) + 0.5, 
                ymin = as.numeric(factor(X2, levels = c("Xylem", "Phloem1", "Phloem2", "EXO_iCOR1", "EXO_iCOR2", "Exodermis1", "Exodermis2", "MZ", "Epidermis1", "Epidermis2", "Vascular1", "Vascular2"))) - 0.5, ymax = as.numeric(factor(X2, levels = c("Xylem", "Phloem1", "Phloem2", "EXO_iCOR1", "EXO_iCOR2", "Exodermis1", "Exodermis2", "MZ", "Epidermis1", "Epidermis2", "Vascular1", "Vascular2"))) + 0.5), 
            fill = NA, color = "green4", size = 1) +
       theme(legend.position="right", 
                  axis.line.x = element_line(size = 1),
                  axis.line.y = element_line(size = 1),
...
pdf("/Users/tranchau/Documents/SC_crossSpecies/092522_allSteps/Figure/Figure_independentTest/111222_Independent_SHAP/030823_Rice_Tom_count.pdf", width = 7, height = 5)
plot_Rice_Tom
dev.off()
```
...
plot_ATH_Maize = ggplot(df1, aes(x = factor(X1, levels = c("Xylem","Cortex", "Phloem", "Meristem_Endocortex", "Endodermis", "Stele1", "Stele2", "Trichoblast1", "Trichoblast2", "Atrichoblast1", "Atrichoblast2")), y = factor(X2, levels = c("Xylem", "Cortex_like", "Cortex", "Phloem", "Endodermal_Initials","Endodermis1", "Endodermis2", "Stele3", "Stele2", "Stele1", "Epidermis")), fill = value)) +
       geom_tile() + 
       geom_text(aes(label = value), color = "black") +
       scale_fill_gradient(low = "white", high = "tomato1") +
       geom_rect(data = subset(df1, test == "Reject"), 
            aes(xmin = as.numeric(factor(X1, levels = c("Xylem","Cortex", "Phloem", "Meristem_Endocortex", "Endodermis", "Stele1", "Stele2", "Trichoblast1", "Trichoblast2", "Atrichoblast1", "Atrichoblast2"))) - 0.5, xmax = as.numeric(factor(X1, levels = c("Xylem","Cortex", "Phloem", "Meristem_Endocortex", "Endodermis", "Stele1", "Stele2", "Trichoblast1", "Trichoblast2", "Atrichoblast1", "Atrichoblast2"))) + 0.5, 
                ymin = as.numeric(factor(X2, levels = c("Xylem", "Cortex_like", "Cortex", "Phloem", "Endodermal_Initials","Endodermis1", "Endodermis2", "Stele3", "Stele2", "Stele1", "Epidermis"))) - 0.5, ymax = as.numeric(factor(X2, levels = c("Xylem", "Cortex_like", "Cortex", "Phloem", "Endodermal_Initials","Endodermis1", "Endodermis2", "Stele3", "Stele2", "Stele1", "Epidermis"))) + 0.5), 
            fill = NA, color = "green4", size = 1) +
       theme(legend.position="right", 
                  axis.line.x = element_line(size = 1),
                  axis.line.y = element_line(size = 1),
...
df1$test = melt(conclusionTable_0.001)$value
#-----
plot_Rice_Maize = ggplot(df1, aes(y = factor(X2, levels = c("Xylem", "Cortex", "Cortex_like", "Endodermal_Initials", "Epidermis", "Stele2", "Stele3", "Stele1", "Phloem", "Endodermis1", "Endodermis2")), x = factor(X1, levels = c("Xylem", "Cortex_like", "Cortex", "Endodermis", "Meristem", "Atrichoblast", "Trichoblast1", "Trichoblast2", "Exodermis", "Stele","Phloem" )), fill = value)) +
       geom_tile() + 
       geom_text(aes(label = value), color = "black") +
       scale_fill_gradient(low = "white", high = "tomato1") +
       geom_rect(data = subset(df1, test == "Reject"), 
            aes(xmin = as.numeric(factor(X1, levels = c("Xylem", "Cortex_like", "Cortex", "Endodermis", "Meristem", "Atrichoblast", "Trichoblast1", "Trichoblast2", "Exodermis", "Stele","Phloem" ))) - 0.5, xmax = as.numeric(factor(X1, levels = c("Xylem", "Cortex_like", "Cortex", "Endodermis", "Meristem", "Atrichoblast", "Trichoblast1", "Trichoblast2", "Exodermis", "Stele","Phloem" ))) + 0.5, 
                ymin = as.numeric(factor(X2, levels = c("Xylem", "Cortex", "Cortex_like", "Endodermal_Initials", "Epidermis", "Stele2", "Stele3", "Stele1", "Phloem", "Endodermis1", "Endodermis2"))) - 0.5, ymax = as.numeric(factor(X2, levels = c("Xylem", "Cortex", "Cortex_like", "Endodermal_Initials", "Epidermis", "Stele2", "Stele3", "Stele1", "Phloem", "Endodermis1", "Endodermis2"))) + 0.5), 
            fill = NA, color = "green4", size = 1) +
...
pdf("/Users/tranchau/Documents/SC_crossSpecies/092522_allSteps/Figure/Figure_independentTest/111222_Independent_SHAP/030823_Rice_Maize_count.pdf", width = 7, height = 5)
plot_Rice_Maize
dev.off()
```
...
plot_Maize_Tom = ggplot(df1, aes(x =  factor(X1, levels = c("Xylem", "Cortex_like", "Cortex", "Epidermis", "Endodermal_Initials",  "Stele2", "Stele3", "Stele1", "Phloem", "Endodermis1", "Endodermis2")),  y = factor(X2, levels = c("Xylem", "EXO_iCOR1", "EXO_iCOR2", "Epidermis1", "Epidermis2", "MZ", "Exodermis2", "Exodermis1", "Vascular1", "Vascular2", "Phloem1", "Phloem2")), fill = value)) +
       ...
       scale_fill_gradient(low = "white", high = "tomato1") +
       geom_rect(data = subset(df1, test == "Reject"), 
            aes(xmin = as.numeric(factor(X1, levels = c("Xylem", "Cortex_like", "Cortex", "Epidermis", "Endodermal_Initials",  "Stele2", "Stele3", "Stele1", "Phloem", "Endodermis1", "Endodermis2"))) - 0.5, xmax = as.numeric(factor(X1, levels = c("Xylem", "Cortex_like", "Cortex", "Epidermis", "Endodermal_Initials",  "Stele2", "Stele3", "Stele1", "Phloem", "Endodermis1", "Endodermis2"))) + 0.5, 
                ymin = as.numeric(factor(X2, levels = c("Xylem", "EXO_iCOR1", "EXO_iCOR2", "Epidermis1", "Epidermis2", "MZ", "Exodermis2", "Exodermis1", "Vascular1", "Vascular2", "Phloem1", "Phloem2"))) - 0.5, ymax = as.numeric(factor(X2, levels = c("Xylem", "EXO_iCOR1", "EXO_iCOR2", "Epidermis1", "Epidermis2", "MZ", "Exodermis2", "Exodermis1", "Vascular1", "Vascular2", "Phloem1", "Phloem2"))) + 0.5), 
            fill = NA, color = "green4", size = 1) +
       theme(legend.position="right", 
                  axis.line.x = element_line(size = 1),
                  axis.line.y = element_line(size = 1),
