...
**This version includes sandbean (*Strophostyles helvola*) genes in the orthogroup file**, enabling direct ortholog mapping for sandbean snRNA-seq data.
...
| File | Description |
|------|-------------|
| `orthogroups_35species.tsv` | Orthogroup definitions across 35 species (including sandbean, *Strophostyles helvola*) from OrthoFinder |
...
├── orthogroups_35species.tsv  # Orthogroup definitions (35 species, including sandbean)
