...
# SPMarker processing
# SPMarker (optional)
Arabidopsis_seurat_rename@meta.data$cellType = Idents(Arabidopsis_seurat_rename)
Arabidopsis_seurat_rename@meta.data$prob = 1
Ath_cell = Arabidopsis_seurat_rename@meta.data %>% select(cellType, prob)
```
...
#saveRDS(Ara_marker, file = "MG_092522_Ath_05.RData")
